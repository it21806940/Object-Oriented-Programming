...
<body>
 ...
 <% 
   ...
   <div class= "wrapper">
        <div class= "title">Delete Shifts</div>
        <div class= "form">
        ...
        <form action="delete" method="post">
          ...
          <input type="text" name="staffname" value="<%= staffname %>" readonly class="input"> <br>
          </div>
          
          <div class="inputfield">
          <label>Work Date</label>
          <input type="date" name="workdate" value="<%= workdate %>" readonly class="input"> <br>
          </div>
          
          <div class="inputfield">
          <label>Start Work</label>
          <input type="time" name="startwork" value="<%= startwork %>" readonly class="input"> <br>
          </div>
          
          <div class="inputfield">
          <label>End Work</label>
          <input type="time" name="endwork" value="<%= endwork %>" readonly> <br><br>
          </div>
    
          <div class="input_field">
          <input class="btn" type="submit" value="delete" name="staffid">
          </div>
